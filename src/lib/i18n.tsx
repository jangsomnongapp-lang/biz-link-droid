...
const dict: Dict = {
  ...
  nav_listings: { km: "គម្រោង", en: "Project" },
  ...
  description: { km: "ប", en: "Description" },
  ...
  store_description: { km: "ប", en: "Description" },
  ...
  cat_vehicles_desc: { km: "ឡានដឹកទំនិញ, រ៉ឺម៉ក...", en: "Trucks, vans..." },
  cat_heavy_desc: { km: "កាប់ដី, ឆ្លងផ្ទះ...", en: "Excavators, cranes..." },
  cat_light_desc: { km: "ផ្សារ, ដុំ...", en: "Welders, grinders..." },
  ...
  min_days: { km: "ថ្ងៃអប្បបរមា", en: "Min. days" },
