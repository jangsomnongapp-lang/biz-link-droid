    ...
    <div className="min-h-screen bg-background pb-10">
      ...
      <article className="mx-auto max-w-2xl space-y-5 px-4 py-5 text-sm leading-relaxed text-foreground">
        ...
        {lang === "km" ? <>
          ...
          <Section title="៣. គណនី និងសុវត្ថិភាព">រក្សាពាក្យសម្ងាត់របស់អ្នកជាការសម្ងាត់។ អ្នកទទួលខុសត្រូវចំពោះសកម្មភាពក្នុងគណនី និងត្រូវដំណឹងភ្លាមៗបើសង្ស័យថាមានការចូលប្រើដោយគ្មានសិទ្ធិ។</Section>
