    ...
    <div className="min-h-screen bg-background pb-10">
      ...
      <article className="mx-auto max-w-2xl space-y-5 px-4 py-5 text-sm leading-relaxed text-foreground">
        ...
        {lang === "km" ? <>
          ...
          <Section title="២. របៀបប្រើទិន្នន័យ">ដើម្បីផ្តល់ និងកែលម្អសេវា ផ្គូផ្គងអ្នកជំនាញ និងអតិថិជន បើកការផ្ញើសារ បង្ហាញការជូនដំណឹង ទប់ស្កាត់ការបោកប្រាស់ និងគោរពកាតព្វកិច្ចច្បាប់។</Section>
          ...
          <Section title="៨. ការផ្លាស់ប្តូរ">យើងអាចកែប្រែគោលការណ៍នេះ ហើយនឹងជូនដំណឹងអំពីការផ្លាស់ប្តូរសំខាន់ៗតាមកម្មវិធី។</Section>
